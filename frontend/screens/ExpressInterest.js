...
export default function ExpressInterest({ navigation, route }) {
    ...
    const submitInterestForm = () => {
        ...
        rfpDatabaseManager.postExpressInterestForm(form, () => {
            rfpDatabaseManager.findExpressInterestFormsForRFP(form.rfpId);    
        });

        //expressInterestManager.submitExpressInterestForm(rfpItem, company, firstName, lastName, email, companyDescription, partner, alternatives);
	...
	return (
		...
		<Background>
			...
			<Logo />
			<Header>Express Interest Form RFP #{rfpItem.id}</Header>
			<ScrollView style={styles.mainScroller}>
				...
				<View style={styles.buttonRow}>
					...
					<View style={styles.buttonView}>
						<Checkbox
							value={partner.value}
							onValueChange={(bool) => setPartner({value:bool, err:""})}
						/>
					</View>
				</View>
				...
				<View style={styles.buttonRow}>
					...
					<View style={styles.buttonView}>
						<Checkbox
							...
							onValueChange={(bool) => setAlternatives({value:bool, error:""})}
						/>
					</View>
				</View>
			</ScrollView>
